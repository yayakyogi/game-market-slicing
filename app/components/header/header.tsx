...
export default function Header() {
  return (
    <div className="sticky top-0 z-20 flex items-center justify-between py-2.5 px-40 backdrop-blur-2xl bg-[radial-gradient(27.22%_77.17%_at_48.72%_50%,#363B9F_0%,#1F2937_100%)]">
      <div className="w-96">
